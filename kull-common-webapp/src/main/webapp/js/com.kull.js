...
(function (win) {
    ...
    win.classForName = function (fullNS) {
    ...
    win.classForName("com.kull");

    com.kull.writeScript = function (src) {
        document.writeln("<script type=\"text/javascript\" src=\"" + src + "\"  ><" + "/script>");
    }

    com.kull.writeStyle = function (href) {
        document.writeln("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + href + "\">");
    }

    com.kull.stringify = function (obj) {
        switch (typeof (obj)) {
            case 'object':
                var ret = [];
